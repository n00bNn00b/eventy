  ...
  return (
    <div className="my-20">
      <div className="flex lg:flex-row-reverse md:flex-col sm:flex-col">
        <div className="my-20 lg:text-right md:text-center sm:text-center mr-20">
          ...
          <div className="lg:block my-5 md:hidden sm:hidden">
            <Link
              to="/create"
      ...
      <div className="lg:hidden md:flex md:mx-auto sm:flex sm:mx-auto">
        <Link
          to="/create"
          className="btn w-48 bg-gradient-to-r from-secondary to-accent border-none mx-auto mb-20"
        >
          {" "}
          🎉 Create my event
        </Link>
